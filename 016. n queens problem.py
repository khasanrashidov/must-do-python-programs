...
N = int(input("Enter N: "))
print("=" * 30)
print("The {}-queens problem solution:".format(N))
print()
...
""" rd is an array where its indices indicate row+col and
used to check whether a queen can be placed on right diagonal or not"""
rd = [0] * 30

"""column array where its indices indicates column and used to check
...
print()
print("=" * 30)
# This code is contributed by KHASAN
